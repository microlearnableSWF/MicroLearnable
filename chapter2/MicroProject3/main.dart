...
class _InteractiveResumeState extends State<InteractiveResume> {
  ...
  Widget buttonSection() {
      ...
      children: [
        Column(
          children: [
            IconButton(
              onPressed: () {
									// Here we are going to call SnackBar.
	...
	/* MicroProject #3 : Show Phone Number with SnackBar
      - Set SnackBar
      - Add an action that calls SnackBar to PHONE button
  */
  void microProject3() {
    // TODO: Set showSnackBar() as 'ScaffoldMessenger.of(context).showSnackBar'
    // TODO: Set SnackBar's content
    // TODO: Set SnackBar's duration
    // TODO: Set SnackBar's action
        // - Set label
        // - Set onpressed() with ScaffoldMessenger.of(context).hideCurrentSnackBar();
  }
