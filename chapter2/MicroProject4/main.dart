...
class _InteractiveResumeState extends State<InteractiveResume> {
      ...
      children: [
        ...
        Column(
          children: [
            IconButton(
              onPressed: () {
								// Here we are going to call AlertDialog.
  ...
  /* MicroProject #4 : Show Email Address with AlertDialog
      - Set AlertDialog
      - Add an action that calls AlertDialog to EMAIL button
  */

  void microProject4() {
    // TODO: Set showDialog(context, builder)
      // TODO: Set AlertDialog in builder
        // TODO: Set title
        // TODO: Set content
        // TODO: Set actions
            // - Set TextButton
            // - print('exit pressed') when TextButton is clicked
  }
